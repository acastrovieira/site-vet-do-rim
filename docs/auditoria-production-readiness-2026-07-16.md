...
**Data:** 2026-07-17 — atualizado em 2026-07-18
...
| FIX-115 | O preflight de readiness marcava Deno como presente, mas descartava sua versão oficial por conter parênteses e registrava “não encontrado”. O sanitizador de versão agora aceita o formato limitado e seguro produzido pelo runtime. | Deno 2.9.3 instalado por pacote com hash verificado; `node --check` e o preflight confirmam `passed` com a versão real. Project ref e senha de staging continuam ausentes no arquivo efetivamente lido, portanto nenhuma consulta remota foi iniciada. |
