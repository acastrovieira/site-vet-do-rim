  ...
  return (
    <>
      ...
      <main id="main-content">
        {/* ══════════════════════════════════════════════════════════
            HERO — Aurora + Palavra Rotativa Animada
        ══════════════════════════════════════════════════════════ */}
        <section
          ...
          style={{
            background:
              'linear-gradient(150deg, #060C1A 0%, #0F1E3D 35%, #1A2E5A 65%, #1a4a80 100%)',
          }}
        >
          {/* Aurora animada */}
          ...
          <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-32 text-center">
            {/* Badge animado */}
            <div className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full border border-white/15 text-white/80 text-xs font-semibold uppercase tracking-widest mb-10 animate-fade-up"
            ...
            <p
              className="mt-6 text-lg sm:text-xl text-white/65 max-w-2xl mx-auto leading-relaxed text-balance animate-fade-up"
            ...
            >
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-bold text-sm transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0"
                style={{
              ...
              <Link
                href="/blog"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-white/20 text-white font-semibold text-sm hover:bg-white/10 hover:-translate-y-0.5 transition-all duration-200"
              >
            ...
            {/* Redes sociais */}
            <div
              className="mt-5 flex items-center justify-center gap-5 animate-fade-up"
        ...
        >
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mt-8">
              <Link
                href="/ferramentas"
                className="inline-flex items-center gap-2 text-sm font-semibold text-gold-400 hover:gap-3 transition-all duration-200"
              >
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {especialidades.map(({ icon: Icon, title, description }) => (
                <article
                  key={title}
                  className="group p-6 rounded-2xl glass-card transition-all duration-300 hover:-translate-y-1.5 hover:border-gold-400/30 hover:shadow-lg"
                >
                  <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-slate-100 dark:bg-white/5 text-gold-500 group-hover:bg-gold-500 group-hover:text-white transition-all duration-300 gold-glow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {diferenciais.map((item) => (
                  <li
                    key={item}
                    className="flex items-start gap-3 p-4 rounded-xl glass-card transition-all duration-200 hover:border-gold-400/30"
                  >
                    <CheckCircle2
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {artigosFeatured.map((artigo) => (
                <article
                  key={artigo.slug}
                  className="group flex flex-col rounded-2xl glass-card overflow-hidden hover:border-gold-400/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
                >
                  <div
                    className="h-40 flex items-center justify-center border-b border-slate-100 dark:border-white/5 transition-all duration-300"
                    style={{ background: 'rgba(128,128,128,0.04)' }}
                  >
                    <Microscope
                      className="h-12 w-12 text-slate-300 dark:text-white/15 group-hover:text-gold-500 transition-colors duration-300"
                      strokeWidth={1.5}
                      aria-hidden
                    />
                  </div>
        ...
        >
          ...
          <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
            <div
              className="rounded-3xl p-10 sm:p-14 glass-card border border-gold-400/20"
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link
                  href="/auth/login"
                  className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl font-bold text-sm transition-all duration-200 hover:-translate-y-0.5"
                  style={{
                    background: 'linear-gradient(135deg, #C9A84C 0%, #D4AF37 100%)',
                ...
                <Link
                  href="/ferramentas/calculadora-tfg"
                  className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl border border-slate-200 dark:border-white/15 bg-slate-50 dark:bg-white/5 text-slate-700 dark:text-white font-semibold text-sm hover:bg-slate-100 dark:hover:bg-white/10 transition-all duration-200"
                >
                  Calcular TFG grátis
                </Link>
              </div>
